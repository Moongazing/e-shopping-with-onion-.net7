...
using TAO.Persistence.Services;
...
using TAO.Persistence.Repositories.File;
...
namespace TAO.Persistence
{
    public static class ServiceRegistration
    {
        ...
        {
            services.AddDbContext<TaoDbContext>(options => options.UseSqlServer(Configuration.ConnectionString));
